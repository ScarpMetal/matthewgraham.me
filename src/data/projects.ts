const projects: JSONBaseType<ProjectType> = {
  ...
  list: [
    ...
    },
    {
      ...
      start_date: new Date('Mar 2017'),
      end_date: new Date('May 2017'),
    },
    {
      ...
      start_date: new Date('Feb 2017'),
      end_date: new Date('Apr 2017'),
    },
    {
    ...
    },
    {
      ...
      start_date: new Date('Sep 2016'),
      end_date: new Date('Nov 2016'),
    },
  ],
};
